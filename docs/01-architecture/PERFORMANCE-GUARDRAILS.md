...
Last updated: 11 July 2026, Australia/Sydney
...
- Keep web-only screens and native-only SDKs behind platform boundaries. Clean the
  hashed web export before measuring so stale chunks cannot inflate results.
