...
| Refactor planning | [`refactor-backlog.md`](refactor-backlog.md) | [`backend-composition-root-map.md`](backend-composition-root-map.md) and the module-size report from `npm run check:architecture` |
