...
| --- | --- | --- |
| Understand the product | [`PROJECT-GOALS-ROADMAP.md`](../PROJECT-GOALS-ROADMAP.md) | [`05-research/`](05-research/) for supporting research, not current commitments |
...
| Review architecture or performance | Relevant document under the future `01-architecture/` category | Dated benchmarks only when the claim needs evidence |

## Folder map

```text
docs/
  00-product-vision/       planned product vision and roadmap home
  01-architecture/         planned architecture and performance home
  02-build-release/        planned testing, privacy, store and support home
  03-provider-data/        provider decisions, implementation and evidence
  04-validation-evidence/  planned validation and historical evidence home
  05-research/             research, strategy and product learning
  06-design-brand/         planned design-system and brand home
  ...
  archive/                 planned superseded-document home
```
