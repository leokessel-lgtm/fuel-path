...
async function installMocks(page) {
  ...
  await page.route("**/api/route?**", async (route) => route.fulfill(jsonResponse({ provider: "map_mock", distanceKm: 859, durationMin: 540, points: [{ lat: -33.8688, lon: 151.2093, label: "Sydney NSW" }, { lat: -35.2809, lon: 149.13, label: "Canberra ACT" }, { lat: -37.8136, lon: 144.9631, label: "Melbourne VIC" }] })));
